...
%%%%% Show the sensor measurement as an arrow (bearing only) 
for l = 1:num_landmarks
    if index_fov(1, l, t)
        bearing = wrapToPi(meas_landmark1(1, l, t) + real_car1(3, t));
        x_end = real_car1(1, t) + max_read_distance * cos(bearing);
        y_end = real_car1(2, t) + max_read_distance * sin(bearing);
        plot([real_car1(1, t), x_end], [real_car1(2, t), y_end], 'Color', 0.5 * ones(1, 3));
    end
    if index_fov(2, l, t)
        bearing = wrapToPi(meas_landmark2(1, l, t) + real_car2(3, t));
        x_end = real_car2(1, t) + max_read_distance * cos(bearing);
        y_end = real_car2(2, t) + max_read_distance * sin(bearing);
        plot([real_car2(1, t), x_end], [real_car2(2, t), y_end], 'Color', 0.5 * ones(1, 3));
    end
end
